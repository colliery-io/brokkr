...
class DiagnosticResult:
    ...
    Attributes:
        collected_at (datetime.datetime): When the diagnostics were collected by the agent.
        created_at (datetime.datetime): When the result was created in the database.
