...
T = TypeVar("T", bound="AgentRegistrationBody")


@_attrs_define
class AgentRegistrationBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_registration_body = cls(
            agent_id=agent_id,
        )

        agent_registration_body.additional_properties = d
        return agent_registration_body
