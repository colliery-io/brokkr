...
) -> ErrorResponse | PodLogHistoryResponse | None:
    if response.status_code == 200:
        response_200 = PodLogHistoryResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | PodLogHistoryResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | PodLogHistoryResponse
    """
