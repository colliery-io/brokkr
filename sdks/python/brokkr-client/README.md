...
```python
from brokkr_broker_client import Client
...
```python
from brokkr_broker_client.models import MyDataModel
from brokkr_broker_client.api.my_tag import get_my_data_model
from brokkr_broker_client.types import Response
...
1. Any endpoint which did not have a tag will be in `brokkr_broker_client.api.default`
