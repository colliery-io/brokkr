...
- [Data Model Design](../explanation/data-model.md) - Entity relationships and design philosophy
- [Audit Logs](./audit-logs.md) - Tracking actions for compliance
- [Managing Stacks](../how-to/managing-stacks.md) - Stack lifecycle including deletion
