...
//     let result = broker::fetch_agent_details(&fixture.settings, &fixture.client).await;
    
//     assert!(result.is_ok(), "Fetching agent details should succeed");
//     let agent = result.unwrap();
//     assert_eq!(agent.name, fixture.settings.agent.agent_name, "Agent name should match the one in settings");
//     assert_eq!(agent.cluster_name, fixture.settings.agent.cluster_name, "Cluster name should match the one in settings");
// }
...
//     let result = broker::fetch_and_process_deployment_objects(&fixture.settings, &fixture.client, &agent).await;
...
//     let deployment_objects = broker::fetch_and_process_deployment_objects(&fixture.settings, &fixture.client, &agent).await.unwrap();
