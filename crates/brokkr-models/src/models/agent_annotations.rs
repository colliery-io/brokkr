...
mod tests {
    ...
    fn test_new_agent_annotation_success() {
        ...
        assert!(result.is_ok(), "NewAgentAnnotation creation should succeed with valid inputs");
        let new_annotation = result.unwrap();
        assert_eq!(new_annotation.agent_id, agent_id, "agent_id should match the input value");
    ...
    fn test_new_agent_annotation_invalid_agent_id() {
        let result = NewAgentAnnotation::new(Uuid::nil(), "test-key".to_string(), "test-value".to_string());
        assert!(result.is_err(), "NewAgentAnnotation creation should fail with nil agent ID");
    ...
    fn test_new_agent_annotation_empty_key() {
        let result = NewAgentAnnotation::new(Uuid::new_v4(), "".to_string(), "test-value".to_string());
        assert!(result.is_err(), "NewAgentAnnotation creation should fail with empty key");
    ...
    fn test_new_agent_annotation_empty_value() {
        let result = NewAgentAnnotation::new(Uuid::new_v4(), "test-key".to_string(), "".to_string());
        assert!(result.is_err(), "NewAgentAnnotation creation should fail with empty value");
    ...
    fn test_new_agent_annotation_key_too_long() {
        ...
        assert!(result.is_err(), "NewAgentAnnotation creation should fail with key exceeding 64 characters");
    ...
    fn test_new_agent_annotation_value_too_long() {
        ...
        assert!(result.is_err(), "NewAgentAnnotation creation should fail with value exceeding 64 characters");
    ...
    fn test_new_agent_annotation_key_with_whitespace() {
        ...
        let result = NewAgentAnnotation::new(Uuid::new_v4(), key_with_space, "test-value".to_string());
        assert!(result.is_err(), "NewAgentAnnotation creation should fail with key containing whitespace");
    ...
    fn test_new_agent_annotation_value_with_whitespace() {
        ...
        let result = NewAgentAnnotation::new(Uuid::new_v4(), "test-key".to_string(), value_with_space);
        assert!(result.is_err(), "NewAgentAnnotation creation should fail with value containing whitespace");
