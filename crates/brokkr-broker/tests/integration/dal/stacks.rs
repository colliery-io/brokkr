...
fn test_get_stack_by_id() {
    ...
    let new_stack = NewStack::new("Test Stack".to_string(), None, None, None, None)
        .expect("Failed to create NewStack");
    let created_stack = fixture
        .dal
        .stacks()
...
fn test_get_all_stacks() {
    ...
    let stack1 = NewStack::new("Stack 1".to_string(), None, None, None, None)
        .expect("Failed to create NewStack");
    let stack2 = NewStack::new("Stack 2".to_string(), None, None, None, None)
        .expect("Failed to create NewStack");
    ...
    let all_stacks = fixture
        ...
        .stacks()
        .get_all()
        .expect("Failed to get all stacks");
...
fn test_update_stack() {
    ...
    let new_stack = NewStack::new("Original Stack".to_string(), None, None, None, None)
        .expect("Failed to create NewStack");
    let created_stack = fixture
        .dal
        .stacks()
    ...
    let result = fixture
        .dal
        .stacks()
        .update(created_stack.id, &updated_stack)
...
fn test_soft_delete_stack() {
    ...
    let new_stack = NewStack::new("To Be Deleted".to_string(), None, None, None, None)
        .expect("Failed to create NewStack");
    let created_stack = fixture
        .dal
        .stacks()
    ...
    let active_stacks = fixture
        .dal
        .stacks()
        .get_active()
        .expect("Failed to get active stacks");
...
fn test_get_active_stacks() {
    ...
    let active_stack = NewStack::new("Active Stack".to_string(), None, None, None, None)
        .expect("Failed to create NewStack");
    let to_delete_stack = NewStack::new("To Delete Stack".to_string(), None, None, None, None)
        .expect("Failed to create NewStack");

    let created_active = fixture
        .dal
        .stacks()
        .create(&active_stack)
        .expect("Failed to create active stack");
    let created_to_delete = fixture
        .dal
        .stacks()
        .create(&to_delete_stack)
        .expect("Failed to create to-delete stack");

    fixture
        .dal
        .stacks()
        .soft_delete(created_to_delete.id)
        .expect("Failed to soft delete stack");
...
fn test_create_stack_with_duplicate_name() {
    ...
    fixture
        ...
        .stacks()
        .create(&new_stack1)
        .expect("Failed to create first stack");
...
fn test_update_stack_agent_target() {
    ...
    assert_eq!(
        result.agent_target,
        Some(json!["updated_agent".to_string()])
    );
}
