...
fn test_create_diagnostic_result() {
    ...
    let stack =
        fixture.create_test_stack("Result Stack".to_string(), None, fixture.admin_generator.id);
