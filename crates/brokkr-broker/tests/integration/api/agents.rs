...
async fn test_list_agents() {
    ...
    assert!(agents.len() >= 3, "Expected at least 3 agents, got {}", agents.len());
...
async fn test_get_agent() {
    ...
    let test_agent = fixture.create_test_agent("Get Test Agent".to_string(), "Get Test Cluster".to_string());

    let response = app
        .oneshot(Request::builder().uri(format!("/api/v1/agents/{}", test_agent.id)).body(Body::empty()).unwrap())
        .await
        .unwrap();
...
async fn test_update_agent() {
    ...
    let test_agent = fixture.create_test_agent("Update Test Agent".to_string(), "Update Test Cluster".to_string());
...
async fn test_delete_agent() {
    ...
    let test_agent = fixture.create_test_agent("Delete Test Agent".to_string(), "Delete Test Cluster".to_string());
    ...
    let deleted_agent = fixture.dal.agents().get_including_deleted(test_agent.id).unwrap().unwrap();
...
async fn test_list_agent_events() {
    ...
    let test_agent = fixture.create_test_agent("Event Test Agent".to_string(), "Event Test Cluster".to_string());
    let test_stack = fixture.create_test_stack("Event Test Stack".to_string(), None);
    let test_deployment_object = fixture.create_test_deployment_object(test_stack.id, "test: yaml".to_string(), false);
...
async fn test_create_agent_event() {
    ...
    let test_agent = fixture.create_test_agent("Event Create Test Agent".to_string(), "Event Create Test Cluster".to_string());
    ...
    assert_eq!(created_event.deployment_object_id, test_deployment_object.id);
    assert_eq!(created_event.event_type, "TEST_CREATE_EVENT");
    assert_eq!(created_event.status, "SUCCESS");
    assert_eq!(created_event.message, Some("Test create event message".to_string()));
}
...
async fn test_list_agent_labels() {
    ...
    let test_agent = fixture.create_test_agent("Label Test Agent".to_string(), "Label Test Cluster".to_string());
    ...
    let response = app
        .oneshot(Request::builder().uri(format!("/api/v1/agents/{}/labels", test_agent.id)).body(Body::empty()).unwrap())
        .await
        .unwrap();
...
async fn test_add_agent_label() {
    ...
    let test_agent = fixture.create_test_agent("Label Add Test Agent".to_string(), "Label Add Test Cluster".to_string());
...
async fn test_remove_agent_label() {
    ...
    let test_agent = fixture.create_test_agent("Label Remove Test Agent".to_string(), "Label Remove Test Cluster".to_string());
    ...
    let response = app
        .oneshot(
            Request::builder()
                .method("DELETE")
                .uri(format!("/api/v1/agents/{}/labels/{}", test_agent.id, label.label))
                .body(Body::empty())
                .unwrap(),
        )
        .await
    ...
    let labels = fixture.dal.agent_labels().list_for_agent(test_agent.id).unwrap();
...
async fn test_add_agent_annotation() {
    ...
    let test_agent = fixture.create_test_agent("Annotation Add Test Agent".to_string(), "Annotation Add Test Cluster".to_string());
...
async fn test_remove_agent_annotation() {
    ...
    let test_agent = fixture.create_test_agent("Annotation Remove Test Agent".to_string(), "Annotation Remove Test Cluster".to_string());
    let annotation = fixture.create_test_agent_annotation(test_agent.id, "test-key".to_string(), "test-value".to_string());

    let response = app
        .oneshot(
            Request::builder()
                .method("DELETE")
                .uri(format!("/api/v1/agents/{}/annotations/{}", test_agent.id, annotation.key))
                .body(Body::empty())
                .unwrap(),
        )
        .await
    ...
    let annotations = fixture.dal.agent_annotations().list_for_agent(test_agent.id).unwrap();
...
async fn test_list_agent_targets() {
    ...
    let test_agent = fixture.create_test_agent("Target Test Agent".to_string(), "Target Test Cluster".to_string());
    ...
    let response = app
        .oneshot(Request::builder().uri(format!("/api/v1/agents/{}/targets", test_agent.id)).body(Body::empty()).unwrap())
        .await
        .unwrap();
    ...
    assert!(targets.iter().any(|t| t.id == target1.id && t.stack_id == test_stack1.id));
    assert!(targets.iter().any(|t| t.id == target2.id && t.stack_id == test_stack2.id));
}
...
async fn test_add_agent_target() {
    ...
    let test_agent = fixture.create_test_agent("Target Add Test Agent".to_string(), "Target Add Test Cluster".to_string());
...
async fn test_remove_agent_target() {
    ...
    let test_agent = fixture.create_test_agent("Target Remove Test Agent".to_string(), "Target Remove Test Cluster".to_string());
    ...
    let response = app
        .oneshot(
            Request::builder()
                .method("DELETE")
                .uri(format!("/api/v1/agents/{}/targets/{}", test_agent.id, test_stack.id))
                .body(Body::empty())
                .unwrap(),
        )
        .await
    ...
    let targets = fixture.dal.agent_targets().list_for_agent(test_agent.id).unwrap();
...
async fn test_record_agent_heartbeat() {
    ...
    let test_agent = fixture.create_test_agent("Heartbeat Test Agent".to_string(), "Heartbeat Test Cluster".to_string());
    ...
    assert!(updated_agent.last_heartbeat.is_some(), "Heartbeat should be recorded");
    
    let recorded_heartbeat = updated_agent.last_heartbeat.unwrap();
    
    assert!(recorded_heartbeat >= before_heartbeat, 
            "Recorded heartbeat should be after or equal to the time before the request");
    assert!(recorded_heartbeat <= after_heartbeat, 
    ...
    if let Some(original_heartbeat) = test_agent.last_heartbeat {
        assert!(recorded_heartbeat > original_heartbeat, 
